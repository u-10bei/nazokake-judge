...
- **Current Stage**: CONSTRUCTION - U4a Functional Design (Part 2 生成完了・承認待ち)
...
- [x] Functional Design (Part 2 生成完了・承認待ち 2026-07-13。Q5=X: Item.body を D1 格納=U1 波及)
- [ ] NFR Requirements
- [ ] NFR Design
...
- **Next Stage**: U4a NFR Requirements（Functional Design 承認後）
- **Status**: U4a Functional Design（Part 2）生成完了・承認待ち（Request Changes / Continue → NFR Requirements）。Q5=X で Item.body を D1 格納する U1 波及を U4a スコープに含む
